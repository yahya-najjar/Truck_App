...
<link href="{{asset('/assets/admin/css/pages/dashboard3.css')}}" rel="stylesheet">
...
<![endif]-->
<!--alerts CSS -->
<link href="{{asset('/assets/admin/plugins/sweetalert/sweetalert.css')}}" rel="stylesheet" type="text/css">
...
<link href="{{asset('/assets/admin/css/pages/user-card.css')}}" rel="stylesheet">
